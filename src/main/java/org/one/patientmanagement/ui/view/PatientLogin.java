 ...
 * @author Lei
 */
public class PatientLogin extends javax.swing.JPanel implements ControllerBound<PatientLoginController> {
    ...
    @Override
    public void setController(PatientLoginController controller) {
