...
//        bind(AccountManager.class);
        bind(AppointmentManager.class).to(AppointmentManagerImpl.class);
        bind(ConsultationService.class).to(ConsultationServiceImpl.class);
//        bind(DoctorManager.class);
        bind(PatientManager.class).to(PatientManagerImpl.class);
    }
}
